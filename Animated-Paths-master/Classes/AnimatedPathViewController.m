...
//    [path addLineToPoint:bottomRight];
    ...
    CGPathMoveToPoint(path1, NULL, bottomLeft.x, bottomLeft.y);
    CGPathAddLineToPoint(path1, NULL, roofTip.x, roofTip.y);
    CGPathAddLineToPoint(path1, NULL, topRight.x, topRight.y);
    CGPathAddLineToPoint(path1, NULL, topLeft.x, topLeft.y);
    CGPathAddLineToPoint(path1, NULL, bottomRight.x, bottomRight.y);
